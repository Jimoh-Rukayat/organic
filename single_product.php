            ...
            <div class="col-md-5 card-shadow desc p-5 align-items-center mb-5">
                ...
                <div class="d-flex justify-content-around mt-4">
                        <div class="input-group mb-3" style="width:120px">
                            ...
                            <input type="text" class="form-control bg-white text-center qty-input" value='<?php echo $productData["prod_id"]?>'>
                ...
                <button class="btn btn-success col-md-6 btn-sm add2cart" name="add2cart" class="add2cart" value="<?php echo $productData['prod_id']?>" >
